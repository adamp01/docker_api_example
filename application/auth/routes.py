...
def register():
    ...
    201 :
          ...
          Example :
            {
                "message": "Successfully registered new user: test@test.com",
            }
...
def login():
    """Request a token for a registered user.
    ...
    -------
    500:
        Unknown error retrieving token.
    401:
        Unauthorized.
    400 :
        Missing credentials.
    201 :
          ...
          Example :
            {
                "message": "Token generated with 5 minute expiration.",
                "token": "token"
            }
    ...
    try:
        ...
        return generate_response(
            "Token generated with 5 minute expiration.", 200, token=token
        )
    except Exception as e:
